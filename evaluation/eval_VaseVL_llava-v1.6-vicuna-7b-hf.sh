...
INFER_FILE="results/VaseVL_llava-v1.6-vicuna-7b-hf/VaseVL_llava-v1.6-vicuna-7b-hf_inference_answers.jsonl"
...
python evaluation/vqa_evaluation.py \
    ...
    --result-file "results/VaseVL_llava-v1.6-vicuna-7b-hf_evaluation.txt"
