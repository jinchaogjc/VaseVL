...
INFER_FILE="results/VaseVL_Qwen2.5-VL-3B-GRPO-VASEL-ZERO-R1-400/VaseVL_Qwen2.5-VL-3B-GRPO-VASEL-ZERO-R1-404_inference_answers.jsonl"
...
python evaluation/vqa_evaluation.py \
    ...
    --result-file "results/VaseVL_Qwen2.5-VL-3B-GRPO-VASEL-ZERO-R1-400/VaseVL_Qwen2.5-VL-3B-GRPO-VASEL-ZERO-R1-404_evaluation.txt"
