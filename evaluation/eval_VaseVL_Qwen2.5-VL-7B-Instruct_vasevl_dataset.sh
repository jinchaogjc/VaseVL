...
python evaluation/vqa_inference.py \
    --model-path "/inspire/hdd/ws-ba572160-47f8-4ca1-984e-d6bcdeb95dbb/a100-maybe/wangbaode/Codes/LLaMA-Factory/saves/qwen2_5vl_7b_full_sft_vasevl_dataset/full/sft" \
